  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-[#010103] overflow-hidden relative">
      ...
      <div className="relative h-[94%] flex items-center justify-center py-6 px-4">
        <div
          ref={phoneFrameRef}
          className="phone-frame-container relative h-full aspect-[9/19.5] bg-[#050508] rounded-xl p-3 shadow-[0_0_80px_rgba(0,0,0,0.9),0_0_0_4px_#1a1a1f] border border-white/10 flex flex-col group overflow-hidden"
        >
          <div className="absolute top-0 left-0 w-full h-12 flex items-center justify-center z-10 pointer-events-none">
          ...
          <div className="absolute top-8 right-6 z-10 flex flex-col gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300">
            <button
              onClick={handleFullscreen}
              className="w-6 h-6 rounded-sm p-1 bg-black/60 backdrop-blur-xl border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-blue-600 transition-all shadow-2xl"
            ...
            {imageUrl ? (
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#050508]">
                <div className="relative mb-8">
                  <div className="w-20 h-20 border-2 border-yellow-500/10 border-t-yellow-500 rounded-full animate-pulse" />
