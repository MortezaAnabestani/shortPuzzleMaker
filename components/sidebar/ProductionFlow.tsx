      ...
      <div className="flex flex-col gap-1">
        {steps.map((s, idx) => {
          ...
          return (
            <div
              key={s.id}
              className={`group flex items-center justify-between px-3 py-2 rounded-md border transition-all duration-200 ${
                isActive
              ...
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`uppercase tracking-wide font-medium ${
                    isComplete ? "text-slate-400 line-through decoration-slate-600/50" : ""
                  }`}
                >
                  {s.label}
                </span>
